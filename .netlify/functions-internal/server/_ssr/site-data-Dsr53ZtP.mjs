//#region node_modules/.nitro/vite/services/ssr/assets/site-data-Dsr53ZtP.js
var khetsiwe_default = "/assets/khetsiwe-Rf1s0jTT.jpg";
var lesedi_default = "/assets/lesedi-Bu1xWbNY.jpg";
var EMAIL = "Neelapsychologicalservices@gmail.com";
var ADDRESS = "72 Alcade Road, Lynnwood Glen, Pretoria";
var CONTACTS = [
	{
		name: "Khetsiwe Nkosi",
		phone: "076 608 1912",
	...
	{
		name: "Reception",
		phone: "+27 62 497 8206",
		tel: "+27624978206"
	}
];
var ALL_PHONE_NUMBERS = CONTACTS.map((c) => c.tel);
var TEAM = [{
	name: "Khetsiwe Nkosi",
	role: "Counselling Psychologist",
	photo: khetsiwe_default,
	width: 828,
	height: 1199,
	phone: "076 608 1912",
	tel: "+27766081912",
	bio: ["A Counselling Psychologist with experience across community, university and clinical settings. Khetsiwe works with adolescents, young adults, adults, professionals and couples experiencing a range of concerns, including emotional difficulties, grief and loss, trauma, relationship challenges and significant life transitions.", "Her approach to therapy is integrative and client-centred. She believes there is no single way of understanding or supporting every person, and therefore considers each client within the context of their individual experiences, relationships, culture and broader life circumstances."]
}, {
	name: "Lesedi",
	role: "Counselling Psychologist",
	photo: lesedi_default,
	width: 1280,
	height: 1280,
	phone: "072 433 5270",
	tel: "+27724335270",
	bio: ["Lesedi works with adolescents, young adults, adults and couples, supporting clients through a range of concerns, including anxiety, depression, adjustment issues, grief, trauma, relationship difficulties and career-related concerns.", "She takes a client-centred, integrative approach to therapy, drawing on evidence-based interventions to support clients in understanding their experiences, navigating challenges and making meaningful changes."]
}];
...
//#endregion
export { FAQS as a, SERVICES as c, EMAIL as i, SESSION_FORMATS as l, ALL_PHONE_NUMBERS as n, FOCUS_AREAS as o, CONTACTS as r, NAV as s, ADDRESS as t, TEAM as u };
